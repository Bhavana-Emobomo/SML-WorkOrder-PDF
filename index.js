...
exports.handler = async (event) => {
  try {
    ...
    if (VendorName) {
      ...
      const tableXPositions = [28, 55, 250, 440, 490]; // Adjusted positions
      const maxWidthForColumns = [25, 195, 190, 30, 20]; // Updated max widths// Adjusted max widths
      ...
      currentPage.drawLine({
        ...
        end: { x: tableXPositions[tableXPositions.length - 1], y: itemY },
        thickness: 1,
        color: blackColor,
      });
      currentPage.drawLine({
